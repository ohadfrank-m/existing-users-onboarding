...
export function AppsPage() {
  return (
    <>
      {/* Sidebar */}
      <div style={{ width: 296, display: 'flex', alignSelf: 'stretch', background: 'var(--chrome-surface-color)', borderRadius: '16px 0 0 0', padding: '10px 0', display: 'flex', flexDirection: 'column', fontFamily: ff, flexShrink: 0 }}>
