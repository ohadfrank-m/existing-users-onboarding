...
export function WorkSpacePage() {
  return (
    <>
      ...
      <div style={{ width: 296, display: 'flex', alignSelf: 'stretch', background: 'var(--primary-background-color)', borderRadius: '16px 0 0 0', padding: '12px 0', display: 'flex', flexDirection: 'column', fontFamily: ff, flexShrink: 0, overflow: 'hidden' }}>
